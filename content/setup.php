<?php
/**
 * Demo site setup for HB Falks Glasmästeri & Inramningsaffär.
 *
 ...
 *
 * @package HB Falks Glasmästeri & Inramningsaffär
 */
 ...
 * Site settings
 * ----------------------------------------------------------------------- */
update_option( 'blogname', 'HB Falks Glasmästeri & Inramningsaffär' );
...
$home = nps_page(
	...
	nps_pattern( 'falksglasmasteriochin/page-home' ),
...
nps_page(
	'takomlaggning',
	'Takomläggning',
	nps_pattern( 'falksglasmasteriochin/page-replacement' ),
...
nps_page(
	...
	nps_pattern( 'falksglasmasteriochin/page-storm' ),
...
$quote = nps_page(
	'offert',
	'Boka besiktning',
	nps_pattern( 'falksglasmasteriochin/quote-funnel' ),
...
$thanks = nps_page(
	'tack',
	'Tack',
	nps_pattern( 'falksglasmasteriochin/thank-you' ),
...
<p class="has-large-font-size">HB Falks Glasmästeri & Inramningsaffär är ett familjeföretag från Sollentuna. Vi startade 1996 med en bil och en regel vi fortfarande håller oss till: priset vi skriver ner är priset du betalar.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:list -->
HTML;
nps_page( 'om-oss', 'Om HB Falks Glasmästeri & Inramningsaffär', $about_content . "\n\n" . nps_pattern( 'falksglasmasteriochin/cta-inline' ), 'Familjeägt takföretag i norra Stockholm sedan 1996. Egna montörer, fasta priser skriftligt och 10 års garanti.' );
...
nps_page( 'vanliga-fragor', 'Vanliga frågor', $faq_content . "\n\n" . nps_pattern( 'falksglasmasteriochin/cta-inline' ), 'Svar om offert, pris, ROT-avdrag, hur lång tid en takomläggning tar och vad garantin täcker.' );
...
<!-- /wp:paragraph -->
HTML;
$privacy = nps_page( 'integritetspolicy', 'Integritetspolicy', $privacy_content, 'Så använder HB Falks Glasmästeri & Inramningsaffär uppgifterna du skickar med offertformuläret.' );
...
nps_log( 'HB Falks Glasmästeri & Inramningsaffär demo ready.' );
