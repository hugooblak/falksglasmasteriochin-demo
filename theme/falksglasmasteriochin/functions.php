<?php
/**
 * HB Falks Glasmästeri & Inramningsaffär theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "HB Falks Glasmästeri & Inramningsaffär Leads" plugin, so leads survive a theme change.
 *
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'falksglasmasteriochin', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'falksglasmasteriochin' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'falksglasmasteriochin' ) ) );

		register_block_pattern_category( 'falksglasmasteriochin-sections', array( 'label' => __( 'HB Falks Glasmästeri & Inramningsaffär sections', 'falksglasmasteriochin' ) ) );
		register_block_pattern_category( 'falksglasmasteriochin-pages', array( 'label' => __( 'HB Falks Glasmästeri & Inramningsaffär page layouts', 'falksglasmasteriochin' ) ) );
	}
);
